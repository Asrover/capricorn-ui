...
interface SelectInputProps extends Omit<TextInputProps, 'onChange' | 'value' | 'clearable'> {
    view?: 'default' | 'text'
    options: Option[]
...
const SelectInput: React.FC<SelectInputProps> = ({
    ...
    const [inputText, setInputText] = useState(!optionsLikeRightLabel ? selectedOption?.text : textInputValue)
